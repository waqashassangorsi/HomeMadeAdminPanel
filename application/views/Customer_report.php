...
<div class="panel-body">
		<form role="form" method="post" id="brand_from" action="<?php echo base_url();?>Customer_report/report" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
			
		

			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">All Custumer</label>
				
				<div class="col-xs-1">
					<input type="checkbox" id="all" autocomplete="off" class="" name="all_cus" > 
