...
<div class="panel-body">
		<form role="form" method="post" id="brand_from" action="<?php echo base_url();?>VendorPerf/report" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
